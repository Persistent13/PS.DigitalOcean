function New-DODropletSnapshot
{
<#
.Synopsis
...
#>
    ...
    Begin
    {
        ...
        [String]$sessionBody = @{'type'='snapshot';'name'=$Name} | ConvertTo-Json
    ...
    Process
    {
        ...
        {
            if($Force -or $PSCmdlet.ShouldProcess("Snapshotting DropletID $droplet with the name $Name."))
            {
                try
                {
