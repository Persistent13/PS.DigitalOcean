function Enable-DODropletPrivateNetworking
{
<#
.Synopsis
...
#>
    ...
    Process
    {
        ...
        {
            if($Force -or $PSCmdlet.ShouldProcess("Enabling private networking for DropletID $droplet."))
            {
                try
                {
                ...
                catch
                {
                    ...
                    Write-Warning "Could not enable private networking for droplet $droplet.`n`r$errorDetail"
                }
            }
        }
    }
